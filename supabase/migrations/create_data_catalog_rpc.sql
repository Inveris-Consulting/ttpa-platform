    ...
    WITH 
      base_calls AS (
        SELECT 
          ...
          c."Date",
          c."Time",
          COALESCE(c."Representative", r."Representative", CASE WHEN ct."WFE" IS TRUE THEN 'WFE' ELSE 'Unassigned' END) AS rep_name,
    ...
    WITH 
      base_subs AS (
        SELECT 
          ...
          s."Date",
          s."time",
          COALESCE(s."Representative", r."Representative", CASE WHEN ct."WFE" IS TRUE THEN 'WFE' ELSE 'Unassigned' END) AS rep_name,
    ...
    WITH 
      base_deals AS (
        SELECT 
          ...
          d."Date",
          d."time",
          COALESCE(r."Representative", ct_rep."Representative", sub_rep."Representative", CASE WHEN ct."WFE" IS TRUE THEN 'WFE' ELSE 'Unassigned' END) AS rep_name,
